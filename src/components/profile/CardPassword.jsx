    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(updatePassword)} autoComplete="off">
                ...
                <div>
                    <label className="mb-2 block text-sm font-semibold">Confirmar nueva contraseña</label>
                    <input
                        type="password"
                        placeholder="Confirma la nueva contraseña"
                        className="block w-full rounded-md border border-gray-300 py-1 px-2 text-gray-500 mb-5"
                        {...register("confirmpassword", { required: "Confirma tu nueva contraseña" })}
                    />
                ...
                <input
                    ...
                    value={isSubmitting ? "Cambiando..." : "Cambiar"}
                />
            </form>
        </>
    );
